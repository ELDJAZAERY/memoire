...
\MemChapter{Notions sur les réseaux de capteurs sans fils}

\addtocontents{lof}{\textbf{Notions sur les réseaux de capteurs sans fils }}
...
\CustomSection{Un réseau de capteur sans-fil}
...
\CustomSection{Architecture d’un capteur sans-fil}
...
\CustomSection{Architecture d’un réseau de capteurs sans-fil}
...
\subCustomSection{Les couches WSN OSI:}
\begin{itemize}
...
\subCustomSection{Les plans de gestion de la pile protocolaire:}
...
\CustomSection{Domaines d'application des réseaux de capteurs}
...
\subCustomSection{Domaine militaire:}
...
\subCustomSection{Domaine médicale:}
...
\subCustomSection{Domaine environnementale:}
...
\subCustomSection{Domaine commercial:}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=14cm,height=8.5cm]{Chap1/7.png}
	\caption{Les cas d’utilisation d’un réseau de capteurs sans-fil}
	\label{fig:CURCSF}
\end{figure}


\CustomSection{Le problème majeur d’un réseau de capteurs sans fil et le challenge}
