...
\CustomSection{Environnement de travail}

\subCustomSection{Environnement matériel}
...
\subCustomSection{Environnement logiciel}
...
\CustomSection{Jeux de données utilisées}
...
\subCustomSection{Étude comparative}
...
\subsubCustomSection{Comparaison de la méthode coopérative avec les autres approches}
...
\subsubCustomSection{Comparaison de la méthode coopérative avec les travaux liés au DTP}
...
\end{table}
	...
	Comme le tableau \ref{tab:7} le montre, parmi les quatre  instances, la meilleure solution (BS) obtenue par la coopération est similaire à celle obtenue par SSGA dans 11 instances et est moins bonne que la BS trouvé par SSGA dans une seule instance (400\_3).
...
le tableau \ref{tab:1} synthétise les résultats trouvés par les approches proposées.
...
\subCustomSection{Analyse graphique}

\subsubCustomSection{Étude comparative entre les différentes approches sur les meilleures solutions (BS) }
...
\subsubCustomSection{Comparaison de la qualité moyenne des solutions (AVG) de l’approche coopérative  et des autres approches}
